...
data = pd.read_csv('/Users/abigailrillovick/Desktop/26s-ds2500-rillovick/project/Boston_food_drink_licenses.csv')
...
# Food/drink business age by neighborhood: box plot
data = data.dropna(subset=['neighborhood'])
...
plt.xticks(rotation=45, ha='right')
plt.title('Distribution of Food/Drink Business Age by Neighborhood')
plt.xlabel('Neighborhood')
plt.ylabel('Business Age (Years)')
plt.tight_layout()
plt.savefig('boxplot_food/drink_age_by_neighborhood.png')
plt.show()