...
def main():
    ...
    plt.tight_layout()
    plt.savefig(SAVE_FOLDER + 'alcohol_by_neighborhood.png')
    plt.show()
    ...
    plt.xticks(rotation=45, ha='right')
    plt.tight_layout()
    plt.savefig(SAVE_FOLDER + 'alcohol_pct_by_neighborhood.png')
    plt.show()
    ...
    plt.tight_layout()
    plt.savefig(SAVE_FOLDER + 'boxplot_age_by_neighborhood.png')
    plt.show()
